...
?>
<form action="<?php echo JRoute::_('index.php?option=com_crowdfundingfinance&view=transactions'); ?>" method="post"
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <div id="filter-bar" class="btn-toolbar">
                <div class="filter-search btn-group pull-left">
                    ...
                    <input type="text" name="filter_search" id="filter_search" class="hasTooltip"
                           placeholder="<?php echo JText::_('COM_CROWDFUNDINGFINANCE_SEARCH_IN_TRANSACTION'); ?>"
                           value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
                           title="<?php echo JText::_('COM_CROWDFUNDINGFINANCE_SEARCH_IN_TRANSACTION_TOOLTIP'); ?>"/>
                </div>
            ...
            <table class="table table-striped" id="transactionsList">
