        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php echo ($active['step2']) ? 'class="active"' : ''; ?>>
                    ...
                    <?php } else { ?>
                        <a href="javascript: void(0);" class="disabled">(2) <?php echo JText::_('COM_CROWDFUNDING_LAYOUT_PAYMENT_WIZARD_STEP2_TITLE'); ?></a>
                    <?php } ?>
                </li>
                ...
                <li <?php echo ($active['payment']) ? 'class="active"' : ''; ?>>
                    ...
                    <?php } else { ?>
                        <a href="javascript: void(0);" class="disabled">(3) <?php echo JText::_('COM_CROWDFUNDING_STEP_PAY'); ?></a>
                    <?php } ?>
                </li>
                ...
                <li <?php echo ($active['share']) ? 'class="active"' : ''; ?>>
                    ...
                    <?php } else { ?>
                        <a href="javascript: void(0);" class="disabled">(4) <?php echo JText::_('COM_CROWDFUNDING_STEP_SHARE'); ?></a>
                    <?php } ?>
                </li>
            </ul>
        </div>
